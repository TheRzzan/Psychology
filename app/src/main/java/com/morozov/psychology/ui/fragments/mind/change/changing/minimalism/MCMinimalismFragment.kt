package com.morozov.psychology.ui.fragments.mind.change.changing.minimalism
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonAddNewThink.setOnClickListener {
            mPresenter.saveNewThink(
                ...
                when (selectedEmotion.value) {
                    0 -> EmotionModel(EmotionModel.Emotion.JOY, seekBarMinEmotions.progress)
                    1 -> EmotionModel(EmotionModel.Emotion.SADNESS, seekBarMinEmotions.progress)
                    2 -> EmotionModel(EmotionModel.Emotion.ANNOYANCE, seekBarMinEmotions.progress)
                    3 -> EmotionModel(EmotionModel.Emotion.ANXIETY, seekBarMinEmotions.progress)
                    4 -> EmotionModel(EmotionModel.Emotion.DISGUST, seekBarMinEmotions.progress)
                    5 -> EmotionModel(EmotionModel.Emotion.INTEREST, seekBarMinEmotions.progress)
                    6 -> EmotionModel(EmotionModel.Emotion.GUILT, seekBarMinEmotions.progress)
                    7 -> EmotionModel(EmotionModel.Emotion.RESENTMENT, seekBarMinEmotions.progress)
        ...
        selectedEmotion.observeForever {
            ...
            if (it != null) {
                ...
                textMinEmotion.visibility = View.VISIBLE
                textMinEmotionsPercent.visibility = View.VISIBLE
                seekBarMinEmotions.visibility = View.VISIBLE
                seekBarMinEmotions.progress = 1
            } else {
                setSelectedEmotion(-1)
                textMinEmotion.visibility = View.GONE
                textMinEmotionsPercent.visibility = View.GONE
                seekBarMinEmotions.visibility = View.GONE
            }
        }
        seekBarMinEmotions.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                textMinEmotionsPercent.text = "$progress%"
        ...
        editAllowableError.addTextChangedListener(object : TextWatcher {
            override fun afterTextChanged(s: Editable?) {
    ...
    * */
    ...
    private fun isReadyToSave(): Boolean {
        return editNewThink.text.toString().isNotEmpty() &&
                editAllowableError.text.toString().isNotEmpty() &&
                selectedEmotion.value != null
    }
    ...
    private fun setEmotion(b: Boolean, name: String, draw1: Drawable, draw2: Drawable,
        ...
        when (b) {
            true -> {
                ...
                textMinEmotionsPercent.text = name
                text.text = "1%"
