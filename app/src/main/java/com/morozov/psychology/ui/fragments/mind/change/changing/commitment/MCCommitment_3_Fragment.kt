...
import com.morozov.psychology.mvp.views.mind.change.changing.commitment.MCCommitment_3_View
...
class MCCommitment_3_Fragment: MvpAppCompatFragment(), MCCommitment_3_View {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        editComWish.addTextChangedListener(object : TextWatcher {
    ...
    * */
    ...
    private fun isReadyToSave(): Boolean {
        return editComWish.text.toString().isNotEmpty() &&
                selectedEmotion.value != null
    }
    ...
    /*
    * MCCommitment_3_View implementation
    *
    * */
