...
class DeepMindTestFragment: Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        linearRoot.addTextAndEdit(
                "Вам предстоит отвечать на вопрос, а затем читать ответ и снова задавать себе вопрос уже применительно к этому ответу. Так с каждым разом вы будете все глубже и глубже погружаться в исследование смысла своего убеждения. Если вы стали повторяться с ответами, то можете остановить свои поиски. \n\nНачнем. Ответьте на вопрос: Что эта мысль значит для вас? ",
            textEnterAnswer
        )
        linearRoot.addTextAndEdit(
    ...
    private fun LinearLayout.addButton(text: String) {
        ...
        button.setOnClickListener {
            mActivityPresenter.showSelectMind(listOfThinks)
        }
        try {
