package com.morozov.psychology.ui.fragments.mind.change.changing.personalization
...
class MCPersonalizationFragment: MvpAppCompatFragment(), MCPersonalizationView, MindChangeTest {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        selectedEmotion.observeForever {
            ...
            if (it != null) {
                ...
                textPersEmotion.visibility = View.VISIBLE
                textPersEmotionsPercent.visibility = View.VISIBLE
                seekBarPersEmotions.visibility = View.VISIBLE
                seekBarPersEmotions.progress = 1
            } else {
                setSelectedEmotion(-1)
                textPersEmotion.visibility = View.GONE
                textPersEmotionsPercent.visibility = View.GONE
                seekBarPersEmotions.visibility = View.GONE
            }
        }
        seekBarPersEmotions.setOnSeekBarChangeListener(object : SeekBar.OnSeekBarChangeListener{
            override fun onProgressChanged(seekBar: SeekBar?, progress: Int, fromUser: Boolean) {
                textPersEmotionsPercent.text = "$progress%"
    ...
    * */
    ...
    private fun isReadyToSave(): Boolean {
        return editAns2.text.toString().isNotEmpty() &&
