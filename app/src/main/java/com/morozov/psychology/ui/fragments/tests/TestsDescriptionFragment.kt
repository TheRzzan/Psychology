...
class TestsDescriptionFragment: MvpAppCompatFragment(), TestsDescriptionView {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if ((name == AppConstants.INTEGRATIVE_TEST || name == AppConstants.LAZARUS_QUESTIONNAIRE_TEST) && (aboutLoader.getAboutModel() == null || aboutLoader.getAboutModel()!!.sex == null || aboutLoader.getAboutModel()!!.age == 0)) {
