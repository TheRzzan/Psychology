    ...
    * */
    ...
    private fun getEResStr(scoreKat: Int, scoreDoljSelf: Int, scoreDoljOthers: Int,
        ...
        val pSM2: String = when {
            scoreSelfMax <= 30 -> "Вы часто оцениваете не отдельные черты или поступки людей, а личность в целом. Это касается не только окружающих, но и вас самих. Зачастую это приводит к выраженному снижению самооценки и частому раздражению. Во время работы с собственными мыслями рекомендуем вам обратить внимание на проработку ошибки мышления «навешивание ярлыков»."
            scoreSelfMax in 31..45 -> "Вы склонны оценивать не отдельные черты или поступки людей, а личность в целом. Это касается не только окружающих, но и вас самих. Эта привычка может приводить к выраженному снижению самооценки. Во время работы с собственными мыслями рекомендуем вам обратить внимание на проработку ошибки мышления «навешивание ярлыков»."
    ...
    * */
    ...
    private fun getIResStr(scoreED_LT: Int, scoreAST_LT: Int, scoreFOB_LT: Int, scoreOP_LT: Int, scoreSZ_LT: Int,
        ...
        when (scoreED_LT) {
            ...
            in 7..9 -> str1 += "Тревога влияет на ваше настроение, снижая его. В результате возникает неудовлетворенность жизненной ситуацией, эмоциональная напряженность, периодическое беспокойство. "
        }
        ...
        when (scoreED_ST) {
            ...
            in 7..9 -> str2 += "Тревога влияет на ваше настроение, снижая его. В результате возникает неудовлетворенность жизненной ситуацией, эмоциональная напряженность, периодическое беспокойство. "
        }
