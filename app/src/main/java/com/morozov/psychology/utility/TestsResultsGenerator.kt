...
class TestsResultsGenerator {
    ...
    * */
    ...
    private fun getLQResStr(tBallKonKop: Int, tBallDistan: Int, tBallSamokt: Int,
        ...
        val str4 = "поиск социальной поддержки"
        when (tBallSocHlp) {
        ...
        val str5 = "принятие ответственности"
        when (tBallPrOtvt) {
        ...
        val str8 = "положительная переоценка"
        when (tBallPolPer) {
