    ...
    * */
    ...
    private fun getEResStr(scoreKat: Int, scoreDoljSelf: Int, scoreDoljOthers: Int,
        ...
        val pK2: String = when {
            ...
            scoreKat >= 46 -> "Вы не склоны преувеличивать степень негативных последствий ситуаций. Неблагоприятные события кажутся вам вполне переносимыми."
            else -> ""
        }
        val p1 = Pair(pK1, pK2)
